...
- [MRtrix3_connectome](https://github.com/bids-apps/MRtrix3_connectome): Generate subject connectomes from raw BIDS data & perform inter-subject connection density normalization, using  the MRtrix3 software package.
...
- <img src='./images/logo_python.png' width='14px'> [ancp-bids](https://ancpbids.readthedocs.io/en/latest/): A Python package to read/write/query/validate BIDS datasets.
  <br>[![Last commit](https://img.shields.io/github/last-commit/ANCPLabOldenburg/ancp-bids?style=plastic)](https://github.com/ANCPLabOldenburg/ancp-bids) [![PyPI version](https://badge.fury.io/py/ancpbids.svg)](https://pypi.org/project/ancpbids/)
...
- <img src='./images/logo_python.png' width='14px'> [bids stats model](https://bids-standard.github.io/stats-models/index.html): Validate BIDS statistical model. To learn more the [BIDS stats model website](https://bids-standard.github.io/stats-models/index.html)
  <br>[![Last commit](https://img.shields.io/github/last-commit/bids-standard/stats-models?style=plastic)](https://github.com/bids-standard/stats-models) [![PyPI version](https://badge.fury.io/py/bsmschema.svg)](https://pypi.org/project/bsmschema/)
...
- <img src='./images/logo_python.png' width='14px'> [bids2table](https://childmindresearch.github.io/bids2table/bids2table.html): bids2table is a library for efficiently indexing and querying large-scale BIDS neuroimaging datasets and derivatives.
  <br>[![Last commit](https://img.shields.io/github/last-commit/childmindresearch/bids2table?style=plastic)](https://github.com/childmindresearch/bids2table) [![PyPI version](https://badge.fury.io/py/bids2table.svg)](https://pypi.org/project/bids2table/)
...
- <img src='./images/logo_matlab.png' width='17px'> [Brainstorm](http://neuroimage.usc.edu/brainstorm/): MEG/EEG analysis package
  <br>[![Last commit](https://img.shields.io/github/last-commit/brainstorm-tools/brainstorm3?style=plastic)](https://github.com/brainstorm-tools/brainstorm3)
...
- <img src='./images/logo_python.png' width='14px'> [HALFpipe](https://github.com/HALFpipe/HALFpipe?tab=readme-ov-file#getting-started): wrapper for fmriprep and commong resting-stat and statistical analysis for fMRI
  <br>[![Last commit](https://img.shields.io/github/last-commit/HALFpipe/HALFpipe?style=plastic)](https://github.com/HALFpipe/HALFpipe)
...
- <img src='./images/logo_python.png' width='14px'> [LazyBIDS](https://lazybids.github.io/lazybids/): Python package to interact with BIDS datasets in a pythonic way. A BIDS dataset is read to hierarchical pydantic models (e.g. dataset->subjects->sessions->scans), variables are accesibles as model properties, tables, SimpleITK Images and numpy arrays. Also serves as python client for lazybids-ui server.
  <br>[![Last commit](https://img.shields.io/github/last-commit/lazybids/lazybids?style=plastic)](https://github.com/lazybids/lazybids) [![PyPI version](https://badge.fury.io/py/lazybids.svg)](https://pypi.org/project/lazybids/)
- <img src='./images/logo_python.png' width='14px'> [LazyBIDS-ui](https://lazybids.github.io/lazybids-ui/): FastAPI web server providing a GUI to explore (imaging) BIDS datasets interactively, also provides (XNAT-like) REST-API to access (parts of) datasets on a client machine. Uses NiiVue to view and navigate (3D) images in the browser.
  <br>[![Last commit](https://img.shields.io/github/last-commit/lazybids/lazybids-ui?style=plastic)](https://github.com/lazybids/lazybids-ui) [![PyPI version](https://badge.fury.io/py/lazybids-ui.svg)](https://pypi.org/project/lazybids-ui/)
- <img src='./images/logo_matlab.png' width='17px'> [Lead-DBS](https://www.lead-dbs.org/): A toolbox facilitating Deep Brain Stimulation electrode reconstructions and computer simulations supports BIDS conversion and ingestion of BIDS datasets.
  <br>[![Last commit](https://img.shields.io/github/last-commit/netstim/leaddbs?style=plastic)](https://github.com/netstim/leaddbs)
...
- <img src='./images/logo_python.png' width='14px'> [mne-bids-pipeline](https://mne.tools/mne-bids-pipeline/stable/index.html): MNE-BIDS-Pipeline is a full-flegded processing pipeline for your MEG and EEG data. Under the hood, it uses MNE-Python.
  <br>[![Last commit](https://img.shields.io/github/last-commit/mne-tools/mne-bids-pipeline?style=plastic)](https://github.com/mne-tools/mne-bids-pipeline)
- [neurobagel annotate](https://neurobagel.org/data_prep/): This tool allows you to create a machine readable data dictionary in .json format for a tabular phenotypic file in .tsv format ("Data table").
  <br>[![Last commit](https://img.shields.io/github/last-commit/neurobagel/annotation_tool?style=plastic)](https://github.com/neurobagel/annotation_tool)
- [neurobagel query](https://neurobagel.org/public_nodes/): Neurobagel's query tool is a web interface for searching across a BIDS datasets based on various subject clinical-demographic and imaging parameters.
  <br>[![Last commit](https://img.shields.io/github/last-commit/neurobagel/query-tool?style=plastic)](https://github.com/neurobagel/query-tool)
- <img src='./images/logo_python.png' width='14px'> [nipopy](https://nipoppy.readthedocs.io/en/latest/): Lightweight neuroimaging workflow manager to help with DICOM to BIDS conversion and running BIDS apps.
  <br>[![Last commit](https://img.shields.io/github/last-commit/nipoppy/nipoppy?style=plastic)](https://github.com/nipoppy/nipoppy)
